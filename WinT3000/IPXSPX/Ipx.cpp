...
//	array = ( IpxControlBlock far *)MK_FP( i, 0 );
	array = GlobalDosAlloc( (unsigned int)(ControlBlocksQueueSize*sizeof( IpxControlBlock ) ) );
...
{
//		DisplayMessageT( 20, 6, 60, 10, NULL, "  Initializing adapter parameters... ", NULL, Blue, NULL, 1500);
