...
DUlong timesec1970;  // sec la inceputul programului
DUlong timestart;    // sec de la inceputul programului

DByte _import   Station_NAME[17];
DInt            networkaddress;
DByte           month_days[12] = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
struct          time ora_start;         // ora la inceputul programului
DUlong          ora_current_sec; // ora curenta exprimata in secunde
...
DByte           Panel_Type = T3000;

//DInt   simulator;
DByte           serial_access;
DByte           default_prg[13];
...
XmsDes          *Des=NULL;
bool            refreshTimeFlag = false;
DInt            refreshTime = -10000;

char *version ="1.0";
DInt Version = 100;    //1.3


DSignedChar     point_des[AY+1]={DOUT,DIN,DVAR,-1,DWR,DAR,DPRG,-1,-1,DAMON,DGRP,DAY};
//char            point_cod[AY+1][5];
...
//DByte *points_text[] = { "Outputs",
char *points_text[] = { "Outputs",
						 "Inputs",
                         "Variables",
                         "Controllers",
                         "Weekly routines",
