...
_export
 ...
 Routing_TABLE_T3000
 {
  public:
        ...
        void Status(DByte s);
        void *Ptr(void);
        PORT_STATUS_variables *Ps(void);
        DInt PortNet(void);
        void PortNet(DInt net);
        void SilenceTimer(DUint st);
        void HeartbeatTimer(DUint ht);
 };

typedef class Routing_TABLE_T3000 ROUTING_TABLE_T3000;
...
#ifndef PTPDLL_DLL
 ROUTING_TABLE_T3000 _import Routing_table[MAX_Routing_table];
#endif
